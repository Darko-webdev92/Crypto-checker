...
export class CoinDetailComponent implements OnInit {
  ...
  getCoinData(){
    this.api.getCurrencyById(this.coinId).subscribe(res=>{
      ...
      if(this.currency === 'USD'){
        ...
        res.market_data.market_cap.eur = res.market_data.current_price.usd;
      }
      res.market_data.current_price.usd = res.market_data.current_price.eur;
      res.market_data.market_cap.usd = res.market_data.current_price.eur;
      this.coinData = res;
    })
  }
  ...
  getGraphData(days: number){
    this.days = days  
    this.api.getGraphicalCurrencyData(this.coinId, this.currency, days).subscribe(res=>{
      setTimeout(()=>{
